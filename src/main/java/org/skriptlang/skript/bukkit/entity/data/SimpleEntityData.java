...
public class SimpleEntityData extends EntityData<Entity> implements EntityItemTypeComparable {
	...
	public static void register() {
		...
		for (EntityType entityType : EntityType.values()) {
			...
			Skript.debug("Missing entity data for: " + name);
		}
		//</editor-fold>
	...
	public boolean canSpawn(@Nullable World world) {
		if (simpleInfo.entityClass.equals(Entity.class))
			return false;
